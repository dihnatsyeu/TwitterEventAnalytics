package com.di.twitter.analytics.web.client.common.api.error.handler;
...
public class WebClientErrorHandler {
    ...
    public String handle(RuntimeException e, Model model) {
        ...
        model.addAttribute("elasticQueryWebClientRequestModel", QueryWebClientRequestModel.builder().build());
